...
- Passwords & SSH (40 Points)
    ...
    - The SSH password has a minimum length of 8 characters, combining uppercase and lowercase letters, numbers, and special characters.  (10 Points)
    - A strong encryption algorithm has been use for the SSH connection  (10 Points)
- OSPF (50 Points)
